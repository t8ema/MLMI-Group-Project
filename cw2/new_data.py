# This data.py script SHOULD put the slices first and lead to a correctly working pipeline
...
target_shape = (128, 128, 32)  # Final shape (x, y, number of slices) - this is rearranged later in the script to make 32, 128, 128
roi_value = 6  # Value in the mask to extract as ROI
image_normalisation = False  # Whether to normalize images between 0 and 1
