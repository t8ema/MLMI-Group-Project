...
model_save_path = './MLMI-Group-Project/cw2/saved_models/residual_unet_step_110.tf' # Path to the model you want to load
...
if __name__ == "__main__":
    ...
    for i, image_name in enumerate(unlabelled_images):  # Loop through all files
        ...
        stacked_image = np.tile(batch_dim_image, (size_minibatch, 1, 1, 1, 1))  # Duplicate the image to fit batch size of 4
