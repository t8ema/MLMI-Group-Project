# Extension of train.py but saves models to saved_models folder
...
freq_save = 4 # How often to save the model
...
for step in range(total_iter):
    ...
    if (step1 % freq_test) == 0:
        ...
        pred_test = residual_unet_model(input_test)
    ...
    if step1 % freq_save == 0:
        model_save_path = os.path.join(SAVE_PATH, f"residual_unet_step_{step}.tf")
